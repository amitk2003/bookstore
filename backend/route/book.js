...
book1.put("/update-book", authToken,async(req,res)=>{
...
book1.delete("/delete-book",async(req,res)=>{
    try {
        const { book_id}=req.headers;
...
book1.get("/get-all",async(req,res)=>{
...
book1.get("/get-book-by-id/:id", async(req,res)=>{
    try{
        const {id} =req.params;
